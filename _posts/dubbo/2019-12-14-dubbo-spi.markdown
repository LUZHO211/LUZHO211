...
>关于Java SPI机制，之前写过一篇：[Java SPI机制](/2019/12/java-spi)，后来了解到Dubbo也实现了一套SPI机制，而不是直接使用Java的SPI。学习了[Dubbo SPI源码](http://dubbo.apache.org/zh-cn/docs/source_code_guide/dubbo-spi.html)之后，写下这篇文章，很多东西直接借鉴原文，但是目的为了巩固所学，加深理解。
